...
class ActionButton: MediumButton {
    ...
    override func commonInit() {
        super.commonInit()
        self.backgroundColor = UIColor.appMain(for: traitCollection)
        self.layer.cornerRadius = 6
        self.setTitleColor(UIColor.white, for: .normal)
        self.setTitleColor(UIColor.white, for: .disabled)
        self.titleLabel?.font = UIFont.appMediumFontOfSize(20)
        setupSpinner()
        updateStyle()
    }
...
class RemoteButton: RegularButton {
    ...
    override func commonInit() {
        ...
        self.backgroundColor = UIColor.appSelection(for: traitCollection)
    ...
    func load(url: String?, altImage: UIImage? = nil, isCircle: Bool = true, cornerRadius: CGFloat = 0, allowsInteraction: Bool = false, backgroundColor: UIColor = UIColor.clear, cacheType: RemoteImageCacheType = .memory) {
